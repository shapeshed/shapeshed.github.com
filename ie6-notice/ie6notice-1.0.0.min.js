...
{		
	...
	Set variables
	------------------------------*/		
	var head, ie6css, body, noticeDiv, hideParagraph;
	...
	/*------------------------------
	Insert notice using the hammer of InnerHTML
	------------------------------*/
	noticeDiv.innerHTML='<p id="ie6-text">You appear to be browsing this site using Internet Explorer 6. This browser is now out of date. For safer, more reliable browsing it is recommended that you upgrade your browser to to <a href="http://www.mozilla.com/firefox/">Firefox</a>, <a href="http://www.apple.com/safari/">Safari</a>, <a href="http://www.opera.com/">Opera</a>, or <a href="http://www.microsoft.com/windows/internet-explorer/">Internet Explorer 8</a></p><p id="ie6-hide-notice"><a href="#">Hide this message</a></p>';
	
	/*------------------------------
	Get the hide paragraph so we can hide it
	------------------------------*/	
	hideParagraph = document.getElementById("ie6-hide-notice")
